...
python extract_videos2jpgs.py /home/jovyan/python/XAI_Autonomous_Driving/dataset/road/

CUDA_VISIBLE_DEVICES=2 python main.py /home/jovyan/python/XAI_Autonomous_Driving/dataset/road/ /home/jovyan/python/XAI_Autonomous_Driving/ /home/jovyan/python/XAI_Autonomous_Driving/3D-RetinaNet/road-pt --MODE=gen_dets --MODEL_TYPE=I3D --TEST_SEQ_LEN=8 --TRAIN_SUBSETS=train_3 --SEQ_LEN=8 --BATCH_SIZE=4 --LR=0.0041 

#data_root,SAVE_ROOT,MODEL_PATH
